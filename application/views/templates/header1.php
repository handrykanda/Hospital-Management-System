...
<head>
 ...
 <script src="http://cdn.datatables.net/1.10.19/js/jquery.dataTables.min.js" type="text/javascript"></script>
  ...
  <style>
    ...
    .nav-menu > li > button#logout {background: #ffffff;color: #50d8af; border: 2px solid #50d8af;padding: 5px 15px;}
    ...
    <div class="container">
      ...
      <nav id="nav-menu-container">
        <ul class="nav-menu">
          ...
          <li><button id="sign_up" data-toggle="modal" data-target="#myModal" class="btn btn-sm">
            <a href="<?php echo base_url('register'); ?>">Sign Up</a>
          </button></li>
          <li><button id="login"  data-toggle="modal" data-target="#myModal" class="btn btn btn-sm" >
            <a href="<?php echo base_url('login'); ?>">Login</a>
          </button></li>
          <li><button id="logout" style="display: none;" class="btn btn btn-sm" type="submit">Logout</button></li>
        </ul>
